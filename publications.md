...
[5] Yikai Zhang（研究生）, Ruiqi Guo（研究生）, **Yong Peng**, Wanzeng Kong, Feiping Nie, and Bao-Liang Lu. An incremental RVFL network with feature reweighting for EEG-based driving fatigue detection. _IEEE Transactions on Instrumentation and Measurement_, in press, October 2022.(SCI, IF: 5.332)  
...
[7]	Ruiqi Guo（研究生）, **Yong Peng**, Wanzeng Kong and Fan Li. Semi-supervised label distribution learning by jointly exploring label correlations and local data manifold. _Journal of King-Saud University-Computer and Information Sciences_, DOI: 10.1016/j.jksuci.2022.10.008, 2022. (SCI, IF: 8.839)   
