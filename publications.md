...
#### 2022
[1] **Yong Peng**, Fengzhe Jin, Wanzeng Kong, Feiping Nie, Bao-Liang Lu, and Andrzej Cichocki. OGSSL: a semi-supervised classification model coupled with optimal graph learning for EEG emotion recognition. IEEE Transactions on Neural Systems and Rehabilitation Engineering, accepted, 2022.(SCI二区)   
...
[5]	Bing Yang, Xueqin Xiang, Wanzeng Kong, **Yong Peng**, Jinliang Yao. Adaptive multi-task learning using lagrange multiplier for automatic art analysis. _Multimedia Tools and Applications_, 81(3): 3715-3733, 2022. (SCI三区)  
[6]	Fangyao Shen（研究生）, Yong Peng, Guojun Dai, Wanzeng Kong, Bao-Liang Lu. Coupled projection transfer metric learning for cross-session emotion recognition from EEG. Systems, 10(2), 47, DOI:10.3390/systems10020047, 2022.  
